    ...
    public void RefreshWindow() {
      ...
      ToolBarMain.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
		...
		private void pd2_PrintPage(object sender, PrintPageEventArgs ev){
			...
			while(true){//will break out if no more room on page
				...
				if(_lastSectionPrinted==AreaSectionType.None) {
					if(_myReport.Sections.Contains(AreaSectionType.ReportHeader)) {
						ReportComplexEvent.Fire(new ODEventArgs("ReportComplexEvent","\t"+Lan.g("ReportComplex","Printing Report Header")+"..."));
				...
				if(_myReport.Sections.Contains(AreaSectionType.PageHeader)) {
					ReportComplexEvent.Fire(new ODEventArgs("ReportComplexEvent","\t"+Lan.g("ReportComplex","Printing Page Header")+"..."));
				...
				if(isRoomForReportFooter){
					if(_myReport.Sections.Contains(AreaSectionType.ReportFooter)) {
						ReportComplexEvent.Fire(new ODEventArgs("ReportComplexEvent","\t"+Lan.g("ReportComplex","Printing Report Footer")+"..."));
				...
				if(_myReport.Sections.Contains(AreaSectionType.PageFooter)) {
					ReportComplexEvent.Fire(new ODEventArgs("ReportComplexEvent","\t"+Lan.g("ReportComplex","Printing Page Footer")+"..."));
			...
			_pagesPrinted++;
			ReportComplexEvent.Fire(new ODEventArgs("ReportComplexEvent",Lan.g("ReportComplex","Page Printed. Preparing Next Page")+"..."));
		...
		private void PrintQuerySection(Graphics g,Section section,int xPos,int yPos) {
			ReportComplexEvent.Fire(new ODEventArgs("ReportComplexEvent",Lan.g("ReportComplex","Printing Query Section")+"..."));
			section.Height=0;
			ReportObject textObject;
			ReportObject lineObject;
			ReportObject boxObject;
