					...
					if(apiToken=="") {
						...
						if(apiToken.ToLower()=="premise") {
							...
							try {
								...
								MessageBox.Show("Error occurred: "+e.Message+" Please login to your Xbeyon/DentalTek Application and try again.");
								return false;
							}
							MessageBox.Show(String.Format("Token: {0}",token));
							request="https://extapi.dentaltek.com/v1/pbx/rest/ClickToCall?phoneNumber=7202838475&token="+token+"&premise=true";
						}
						else {
