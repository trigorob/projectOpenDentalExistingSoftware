	...
	public class SheetPrinting {
		...
		public static void drawFieldText(SheetField field,Sheet sheet,Graphics g,XGraphics gx) {
			...
			if(gx==null){
				...
				GraphicsHelper.DrawString(g,field.FieldValue,font,(field.ItemColor==Color.FromArgb(0)?Brushes.Black:new SolidBrush(field.ItemColor)),bounds,field.TextAlign);
				font.Dispose();
				font=null;
			}
			else{
				...
				GraphicsHelper.DrawStringX(gx,field.FieldValue,xfont,(field.ItemColor==Color.FromArgb(0)?XBrushes.Black:new XSolidBrush(field.ItemColor)),rect,field.TextAlign);
				//xfont.Dispose();
				xfont=null;
			}
