...
///<summary></summary>
    ...
    private CheckBox checkClinicInfo;
		...
		private void InitializeComponent()
		{
			...
			this.groupShowInsWriteoffs.Location = new System.Drawing.Point(390, 211);
			this.groupShowInsWriteoffs.Name = "groupShowInsWriteoffs";
			this.groupShowInsWriteoffs.Size = new System.Drawing.Size(281, 131);
			...
			this.radioWriteoffProc.Location = new System.Drawing.Point(9, 57);
			...
			this.radioWriteoffPay.Location = new System.Drawing.Point(9, 30);
			...
			this.checkShowUnearned.Location = new System.Drawing.Point(96, 137);
			this.checkShowUnearned.Name = "checkShowUnearned";
			this.checkShowUnearned.Size = new System.Drawing.Size(113, 16);
    ...
    private void checkClinicInfo_CheckedChanged(object sender,EventArgs e) {
		...
		private void RunDaily() {
			...
			DataSet dataSetDailyProd=RpProdInc.GetDailyData(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked
				,checkAllProv.Checked,checkAllClin.Checked,checkClinicBreakdown.Checked,checkClinicInfo.Checked,checkShowUnearned.Checked);
      ...
      Font font=new Font("Tahoma",8);
		...
		private void RunMonthly(){
			...
			DataSet ds=RpProdInc.GetMonthlyData(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked,checkAllProv.Checked,checkAllClin.Checked,checkShowUnearned.Checked);
		...
		private void RunAnnual(){
			...
			DataSet ds=RpProdInc.GetAnnualData(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked,checkAllProv.Checked,checkAllClin.Checked,checkShowUnearned.Checked);
			DataTable dt=ds.Tables["Total"];
			DataTable dtClinic=new DataTable();
			if(!PrefC.GetBool(PrefName.EasyNoClinics)) {
				dtClinic=ds.Tables["Clinic"];
		...
		private void RunProvider() {
			...
			DataSet ds=RpProdInc.GetProviderDataForClinics(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked,checkAllProv.Checked,checkAllClin.Checked,checkShowUnearned.Checked);
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if(!checkAllProv.Checked && listProv.SelectedIndices.Count==0 && !checkShowUnearned.Checked){
