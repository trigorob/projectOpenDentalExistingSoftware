...
///<summary></summary>
	public class FormRpPaySheet : ODForm{
		...
		private void InitializeComponent()
		{
			...
			this.checkShowUnearned.Location = new System.Drawing.Point(26, 362);
		...
		private void butOK_Click(object sender,System.EventArgs e) {
			...
			DataTable tablePat=RpPaySheet.GetPatTable(date1.SelectionStart,date2.SelectionStart,listProvNums,listClinicNums,listPatTypes,
				checkAllProv.Checked,checkAllClin.Checked,checkPatientTypes.Checked,radioPatient.Checked,checkShowUnearned.Checked);
