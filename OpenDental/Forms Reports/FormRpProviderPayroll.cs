...
///<summary></summary>
    ...
    private CheckBox checkClinicInfo;
		...
		private void InitializeComponent()
		{
			...
			this.checkShowUnearned.Location = new System.Drawing.Point(79, 35);
			this.checkShowUnearned.Name = "checkShowUnearned";
			this.checkShowUnearned.Size = new System.Drawing.Size(119, 16);
        ...
        checkClinicInfo.Visible=false;
			...
			checkShowUnearned.Checked=false;
			if(PrefC.HasClinicsEnabled) {
				checkClinicInfo.Visible=false;
				checkClinicBreakdown.Visible=false;
			}
    ...
    private void checkClinicInfo_CheckedChanged(object sender,EventArgs e) {
		...
		private void RunProviderPayroll() {
			...
			DataSet ds=RpProdInc.GetProviderPayrollDataForClinics(dateFrom,dateTo,listProvs,listClinics
				,checkAllProv.Checked,checkAllClin.Checked,radioDetailedReport.Checked,checkShowUnearned.Checked);
