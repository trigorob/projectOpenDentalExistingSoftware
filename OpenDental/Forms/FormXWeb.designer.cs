namespace OpenDental{
	partial class FormXWeb {
		...
		private void InitializeComponent() {
			...
			this.labelRefNumber.TabIndex = 42;
			...
			this.textRefNumber.TabIndex = 54;
			...
			this.groupTransType.TabIndex = 43;
			...
			this.textSecurityCode.TabIndex = 51;
			// 
			// label6
			// 
			...
			this.textNameOnCard.TabIndex = 50;
			// 
			// label5
			// 
			...
			this.textCardNumber.TabIndex = 48;
			// 
			// label3
			// 
