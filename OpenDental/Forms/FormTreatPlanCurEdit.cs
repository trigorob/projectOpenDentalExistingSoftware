	...
	public partial class FormTreatPlanCurEdit:ODForm {
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			if(_presenterCur!=null) {
				TreatPlanCur.UserNumPresenter=_presenterCur.UserNum;
			}
			else {
			...
			if(_presenterCur!=null && (_presenterOld==null || _presenterCur.UserNum != _presenterOld.UserNum)) {
				SecurityLogs.MakeLogEntry(Permissions.TreatPlanPresenterEdit,TreatPlanCur.PatNum,
		...
		private void butPickPresenter_Click(object sender,EventArgs e) {
			...
			List<Userod> listUsers=UserodC.ShortList
				.FindAll(x => x.ClinicIsRestricted == false || x.ClinicNum == Clinics.ClinicNum);
