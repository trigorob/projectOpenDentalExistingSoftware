...
namespace OpenDental {
	public partial class FormPodiumSetup:ODForm {
		...
		private ProgramProperty _showCommlogsInChart;
		...
		private void FormPodiumSetup_Load(object sender,EventArgs e) {
			...
			try {
				...
				_showCommlogsInChart=_listProgramProperties.FirstOrDefault(x => x.PropertyDesc==Podium.PropertyDescs.ShowCommlogsInChart);
			}
			catch(Exception) {
		...
		private void FillForm() {
			try {
				...
				checkShowCommlogsInChart.Checked=PIn.Bool(_showCommlogsInChart.PropertyValue);
		...
		private void SaveProgram() {
			...
			UpdateProgramProperty(_showCommlogsInChart,POut.Bool(checkShowCommlogsInChart.Checked));
