...
namespace OpenDental {
	public partial class FormMedLabEdit:ODForm {
		...
		private void FormMedLabEdit_Load(object sender,EventArgs e) {
			...
			if(PrefC.AtoZfolderUsed!=DataStorageType.LocalAtoZ) { //NOTES: Can HL7 users use DropBox?  We may not want to let them, not sure what else it will affect.
