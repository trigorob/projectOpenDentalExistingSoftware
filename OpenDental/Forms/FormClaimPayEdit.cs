...
///<summary></summary>
	public class FormClaimPayEdit:ODForm {
		...
		private void InitializeComponent(){
			...
			this.butCancel.Location = new System.Drawing.Point(414, 323);
			...
			this.butOK.Location = new System.Drawing.Point(323, 323);
			...
			this.butCarrierSelect.Location = new System.Drawing.Point(384, 196);
		...
		private void FormClaimPayEdit_Load(object sender, System.EventArgs e) {
			...
			if(PrefC.GetBool(PrefName.EasyNoClinics)) {
				...
				for(int i=0;i<Clinics.List.Length;i++) {
					comboClinic.Items.Add(Clinics.List[i].Abbr);
