...
namespace OpenDental{
	...
	public class FormOperatories : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.butDown.Location = new System.Drawing.Point(801, 235);
			...
			this.butUp.Location = new System.Drawing.Point(801, 203);
			...
			this.butAdd.Location = new System.Drawing.Point(796, 31);
			...
			this.butClose.Location = new System.Drawing.Point(801, 437);
		...
		private void FormOperatories_Load(object sender, System.EventArgs e) {
			if(!PrefC.HasClinicsEnabled) {
				...
				for(int i=0;i<_arrayClinics.Length;i++) {
					comboClinic.Items.Add(_arrayClinics[i].Abbr);
		...
		//Swaps two rows in the grid for use with the Up and Down buttons.  Does not edit lists or do any calls to cache or DB to refresh the grid.
