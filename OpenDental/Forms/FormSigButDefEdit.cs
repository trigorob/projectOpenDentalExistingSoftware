    ...
    " button lights up.  0 for none.";
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if(comboTo.SelectedIndex!=0) {
				_sigButDefCur.SigElementDefNumUser=_arraySigElementDefUser[comboTo.SelectedIndex-1].SigElementDefNum;
			}
			if(comboExtras.SelectedIndex!=0) {
				_sigButDefCur.SigElementDefNumExtra=_arraySigElementDefExtras[comboExtras.SelectedIndex-1].SigElementDefNum;
			}
			if(comboMessage.SelectedIndex!=0) {
				_sigButDefCur.SigElementDefNumMsg=_arraySigElementDefMessages[comboMessage.SelectedIndex-1].SigElementDefNum;
			}
			if(IsNew) {
