...
namespace OpenDental {
	...
	public class FormReferralSelect:ODForm {
		...
		private void FillTable() {
			...
			listRef=Referrals.List.Select(x => x.Copy()).ToList();
			...
			foreach(Referral refCur in listRef) {
				...
				row.Cells.Add(refCur.IsDoctor?Lan.g("enumDentalSpecialty",DefC.GetName(DefCat.ProviderSpecialties,refCur.Specialty)):"");
