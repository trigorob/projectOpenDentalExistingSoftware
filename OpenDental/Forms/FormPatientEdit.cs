...
///<summary></summary>
	public class FormPatientEdit : ODForm {
		...
		private void InitializeComponent(){
			...
			// labelRaceEthnicity
			// 
			this.labelRaceEthnicity.Location = new System.Drawing.Point(6, 9);
			this.labelRaceEthnicity.Name = "labelRaceEthnicity";
			this.labelRaceEthnicity.Size = new System.Drawing.Size(148, 14);
			...
			this.tabControlPatInfo.Location = new System.Drawing.Point(488, 402);
			this.tabControlPatInfo.Name = "tabControlPatInfo";
			this.tabControlPatInfo.SelectedIndex = 0;
			this.tabControlPatInfo.Size = new System.Drawing.Size(465, 249);
			...
			this.tabPublicHealth.Controls.Add(this.labelRaceEthnicity);
			...
			this.tabPublicHealth.Size = new System.Drawing.Size(457, 223);
			...
			this.tabHospitals.Size = new System.Drawing.Size(457, 223);
			...
			this.tabOther.Size = new System.Drawing.Size(457, 223);
			...
			this.tabICE.Size = new System.Drawing.Size(457, 223);
			...
			this.tabEHR.Size = new System.Drawing.Size(457, 223);
		...
		private void FormPatientEdit_Load(object sender, System.EventArgs e) {
			...
			checkRestrictSched.Checked=PatRestrictions.IsRestricted(PatCur.PatNum,PatRestrict.ApptSchedule,true);
		...
		private void SetRequiredTextBox(Label labelCur,TextBox textBoxCur,bool areConditionsMet) {
			...
			//If the textbox is on a tab, add an asterisk to the tab title.
		...
		private void SetRequiredComboBox(Label labelCur,ComboBox comboCur,bool areConditionsMet,int disallowedIdx,string errorMsg) {
			...
			//If the combobox is on a tab, add an asterisk to the tab title.
			Control parent=labelCur.Parent;
			while(parent!=null) {
				if(parent is TabPage) {
					((TabPage)parent).Text=((TabPage)parent).Text.Replace("*","")+"*";
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if(checkRestrictSched.Checked) {
				PatRestrictions.Insert(PatCur.PatNum,PatRestrict.ApptSchedule);//will only insert if one does not already exist in the db.
			}
			else {
