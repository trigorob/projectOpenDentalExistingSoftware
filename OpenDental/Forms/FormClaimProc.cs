...
namespace OpenDental
{
	...
	public class FormClaimProc : ODForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.textLabs = new System.Windows.Forms.TextBox();
			...
			// panelEstimateInfo
			// 
			this.panelEstimateInfo.Controls.Add(this.textLabs);
			this.panelEstimateInfo.Controls.Add(this.labelFees);
			...
			// textLabs
			// 
			this.textLabs.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textLabs.Location = new System.Drawing.Point(288, 8);
			this.textLabs.Name = "textLabs";
			this.textLabs.ReadOnly = true;
			this.textLabs.Size = new System.Drawing.Size(58, 13);
			this.textLabs.TabIndex = 9;
			this.textLabs.TabStop = false;
			this.textLabs.Text = "520.00";
			this.textLabs.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.textLabs.Visible = false;
			// 
			// labelFees
			// 
			this.labelFees.Location = new System.Drawing.Point(233, 7);
			this.labelFees.Name = "labelFees";
			this.labelFees.Size = new System.Drawing.Size(51, 14);
			this.labelFees.TabIndex = 8;
			this.labelFees.Text = "Labs";
			this.labelFees.TextAlign = System.Drawing.ContentAlignment.TopRight;
		...
		public void Initialize() {
			...
			if(CultureInfo.CurrentCulture.Name.EndsWith("CA")) {//Canada
				textLabs.Visible=true;
				labelFees.Visible=true;
			}
			FillInitialAmounts();
			ComputeAmounts();
		...
		private void FillInitialAmounts(){
			if(IsProc){
				...
				if(CultureInfo.CurrentCulture.Name.EndsWith("CA")) {//Canada
					_labFeeAmt=Procedures.GetCanadianLabFees(proc.ProcNum).Select(x=>x.ProcFee).Sum();
					textLabs.Text=POut.Double(_labFeeAmt);
				}
