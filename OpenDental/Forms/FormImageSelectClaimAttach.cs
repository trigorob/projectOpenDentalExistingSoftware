			...
			try {
				if(ImageHelper.HasImageExtension(oldPath)) {
					if(doc.CropH !=0
						...
						|| doc.WindowingMax !=0
						|| doc.WindowingMin !=0
						|| PrefC.AtoZfolderUsed==DataStorageType.DropboxAtoZ) 
					{
						...
						if(PrefC.AtoZfolderUsed==DataStorageType.LocalAtoZ) {
							...
							FormP.DisplayText="Downloading Image from Dropbox...";
							...
							FormP.DisplayText="Uploading Image to Dropbox for Claim Attach...";
							FormP.NumberFormat="F";
							FormP.NumberMultiplication=1;
							FormP.MaxVal=100;//Doesn't matter what this value is as long as it is greater than 0
							FormP.TickMS=1000;
