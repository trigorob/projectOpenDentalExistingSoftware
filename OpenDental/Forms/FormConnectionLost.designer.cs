namespace OpenDental{
	partial class FormConnectionLost {
		...
		private void InitializeComponent() {
			...
			this.timerConnTest = new System.Windows.Forms.Timer(this.components);
			...
			// timerConnTest
			// 
			this.timerConnTest.Enabled = true;
			this.timerConnTest.Interval = 30000;
			this.timerConnTest.Tick += new System.EventHandler(this.timerConnTest_Tick);
			// 
			// butRetry
			// 
		...
		private System.Windows.Forms.Timer timerConnTest;
