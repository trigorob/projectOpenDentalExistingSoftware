...
namespace OpenDental {
	public partial class FormXWeb:ODForm {
		...
		public FormXWeb(long patNum,CreditCard creditCard,XWebTransactionType tranType) {
			InitializeComponent();
			Lan.F(this);
			_patNum=patNum;
		...
		private bool ProcessSelectedTransaction() {
			...
			try {
				...
				if(_tranType==XWebTransactionType.CreditReturnTransaction) {
					XWebs.ReturnPayment(_creditCard.PatNum,textPayNote.Text,amount,_creditCard.CreditCardNum);
				}
			}
