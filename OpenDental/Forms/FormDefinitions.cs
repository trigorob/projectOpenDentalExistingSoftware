...
///<summary></summary>
	public class FormDefinitions : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.listCategory.Size = new System.Drawing.Size(147, 433);
		...
		private void FormDefinitions_Load(object sender, System.EventArgs e) {
			...
			lookupCat[11]=DefCat.ClaimPaymentGroups;
			lookupCat[12]=DefCat.CommLogTypes;
			lookupCat[13]=DefCat.ContactCategories;
			lookupCat[14]=DefCat.Diagnosis;
			lookupCat[15]=DefCat.FeeColors;
			lookupCat[16]=DefCat.ImageCats;
			lookupCat[17]=DefCat.InsurancePaymentType;
			lookupCat[18]=DefCat.InsuranceVerificationStatus;
			lookupCat[19]=DefCat.LetterMergeCats;
			lookupCat[20]=DefCat.MiscColors;
			lookupCat[21]=DefCat.PaymentTypes;
			lookupCat[22]=DefCat.PaySplitUnearnedType;
			lookupCat[23]=DefCat.ProcButtonCats;
			lookupCat[24]=DefCat.ProcCodeCats;
			lookupCat[25]=DefCat.ProgNoteColors;
			lookupCat[26]=DefCat.Prognosis;
			lookupCat[27]=DefCat.ProviderSpecialties;
			lookupCat[28]=DefCat.RecallUnschedStatus;
			lookupCat[29]=DefCat.Regions;
			lookupCat[30]=DefCat.SupplyCats;
			lookupCat[31]=DefCat.TaskPriorities;
			lookupCat[32]=DefCat.TxPriorities;			
		...
		private void FillCats(){
			...
			switch(listCategory.SelectedIndex){
				...
				case 10://"Payment Tracking":
					...
					break;
				case 11://"Claim Payment Groups":
					FormDefEdit.EnableColor=false;
					FormDefEdit.ValueText=Lan.g(this,"Value");
					FormDefEdit.HelpText=Lan.g(this,"Used to group claim payments in the daily payments report.");
					break;
				case 12://"Commlog Types"
					FormDefEdit.EnableValue=true;
				...
				case 16://"Image Categories":
					...
					break;
				case 17://"Insurance Payment Types":
					butHide.Visible=false;
					FormDefEdit.CanDelete=true;
					FormDefEdit.CanHide=false;
					FormDefEdit.EnableValue=true;
					...
					break;
				case 18://"Insurance Verification Status":
					butHide.Visible=false;
					FormDefEdit.CanDelete=false;
					FormDefEdit.CanHide=true;
					FormDefEdit.EnableValue=false;
				...
				case 22://paysplit unearned types
					...
					break;
				case 23://"Proc Button Categories":
				...
				case 29://"Regions":
					...
					break;
				case 30://Supply Categories
					butHide.Visible=false;
					FormDefEdit.CanDelete=true;
					FormDefEdit.CanHide=false;
					FormDefEdit.HelpText=Lan.g(this,"The categories for inventory supplies.");
					break;
				case 31://Task Priorities
					FormDefEdit.CanDelete=false;
					FormDefEdit.CanHide=true;
					FormDefEdit.ValueText=Lan.g(this,"D = Default, R = Reminder");
					FormDefEdit.EnableColor=true;
					FormDefEdit.EnableValue=true;
