...
namespace OpenDental{
	public class ApptViewItemL{
		...
		///<summary>Gets the 'visible' operatories for todays date with the currently selected appointment view.  This is strictly used when filtering the waiting room for clinics.  Pass in null for the dailySched if this is a weekly view.</summary>
