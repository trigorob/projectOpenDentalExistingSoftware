...
namespace OpenDentBusiness {
	public class DatabaseMaintenance {
		...
		public static string DatesNoZeros(bool verbose,bool isCheck) {
			...
			if(isCheck) {
				string[] commands=new string[]
				{
				  ...
				  ,"SELECT COUNT(*) FROM sigmessage WHERE AckDateTime LIKE '0000-00-00%'"
					,"SELECT COUNT(*) FROM sigmessage WHERE MessageDateTime LIKE '0000-00-00%'"
				};
				...
				string[] commands=new string[]
				{
				  ...
				  ,"UPDATE sigmessage SET AckDateTime='0001-01-01 00:00:00' WHERE AckDateTime LIKE '0000-00-00%'"
					,"UPDATE sigmessage SET MessageDateTime='0001-01-01 00:00:00' WHERE MessageDateTime LIKE '0000-00-00%'"
				};
				long rowsChanged=0;
				for(int i=0;i<commands.Length;i++) {
		...
		[DbmMethod(HasBreakDown=true)]
		public static string DepositDuplicates(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
			...
			//There is something to report OR the user has verbose mode on.
			int numFound=table.Rows.Count;
			log+=Lans.g("FormDatabaseMaintenance","Duplicate deposits found: ")+numFound;
			if(isCheck && numFound>0) {//Only the fix should show the entire list of items.
				log+="\r\n   "+Lans.g("FormDatabaseMaintenance","Manual fix needed.  Double click to see a break down.")+"\r\n";
			}
			else if(numFound>0) {//Running the fix and there are items to show.
				log+=", "+Lans.g("FormDatabaseMaintenance","including")+":\r\n";
		...
		[DbmMethod]
		public static string EbillDuplicates(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
		...
		[DbmMethod]
		public static string FeeDeleteForInvalidProc(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			if(DataConnection.DBtype==DatabaseType.Oracle) {
		...
		[DbmMethod]
		public static string PatientInvalidBillingType(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
		...
		[DbmMethod]
		public static string PatientInvalidGradeLevel(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
		 }
		 string log="";
		...
		[DbmMethod(HasBreakDown = true)]
		public static string PaySplitWithInvalidPrePayNum(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
			...
			DataTable table=Db.GetTable(command);
			if(table.Rows.Count>0) {
				log+=Lans.g("FormDatabaseMaintenance","Paysplits attached to deleted prepayments")+": "+table.Rows.Count;
			}
			if(isCheck && table.Rows.Count!=0) {//Only the fix should show the entire list of items.
				log+="\r\n   "+Lans.g("FormDatabaseMaintenance","Manual fix needed.  Double click to see a break down.")+"\r\n";
			}
		...
		[DbmMethod]
		public static string ProgramPropertiesDuplicatesForHQ(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
		...
		[DbmMethod]
		public static string ProgramPropertiesMissingForClinic(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			if(DataConnection.DBtype==DatabaseType.Oracle) {
		...
		[DbmMethod]
		public static string QuickPasteNoteWithInvalidCatNum(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
		...
		[DbmMethod]
		public static string RefAttachesWithDuplicateOrder(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
		...
		[DbmMethod]
		public static string SigMessageInFuture(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			string log="";
		...
		[DbmMethod]
		public static string TreatPlanAttachDuplicateProc(bool verbose,bool isCheck) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetString(MethodBase.GetCurrentMethod(),verbose,isCheck);
			}
			if(DataConnection.DBtype==DatabaseType.Oracle) {
