...
namespace OpenDentBusiness{
	...
	public class Payments {
		...
		public static long InsertFromXWeb(long patNum,long provNum,long clinicNum,double amount,string payNote,string receipt) {
			...
			long ret=Payments.Insert(new Payment() {
				...
				PaymentSource=CreditCardSource.XWeb,
