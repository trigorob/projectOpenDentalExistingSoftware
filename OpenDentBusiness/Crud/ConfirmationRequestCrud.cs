...
namespace OpenDentBusiness.Crud{
	public class ConfirmationRequestCrud {
		...
		public static long Insert(ConfirmationRequest confirmationRequest,bool useExistingPK){
			...
			OdSqlParameter paramEmailSubjTemplate=new OdSqlParameter("paramEmailSubjTemplate",OdDbType.Text,confirmationRequest.EmailSubjTemplate);
			if(confirmationRequest.EmailSubj==null) {
				confirmationRequest.EmailSubj="";
			}
			OdSqlParameter paramEmailSubj=new OdSqlParameter("paramEmailSubj",OdDbType.Text,confirmationRequest.EmailSubj);
			if(confirmationRequest.EmailTextTemplate==null) {
				confirmationRequest.EmailTextTemplate="";
			}
			OdSqlParameter paramEmailTextTemplate=new OdSqlParameter("paramEmailTextTemplate",OdDbType.Text,confirmationRequest.EmailTextTemplate);
			if(confirmationRequest.EmailText==null) {
				confirmationRequest.EmailText="";
			}
			OdSqlParameter paramEmailText=new OdSqlParameter("paramEmailText",OdDbType.Text,confirmationRequest.EmailText);
			...
			OdSqlParameter paramGuidMessageToMobile=new OdSqlParameter("paramGuidMessageToMobile",OdDbType.Text,confirmationRequest.GuidMessageToMobile);
			if(confirmationRequest.GuidMessageFromMobile==null) {
				confirmationRequest.GuidMessageFromMobile="";
			}
			OdSqlParameter paramGuidMessageFromMobile=new OdSqlParameter("paramGuidMessageFromMobile",OdDbType.Text,confirmationRequest.GuidMessageFromMobile);
			if(useExistingPK || PrefC.RandomKeys) {
				...
				confirmationRequest.ConfirmationRequestNum=Db.NonQ(command,true,paramMsgTextToMobileTemplate,paramMsgTextToMobile,paramEmailSubjTemplate,paramEmailSubj,paramEmailTextTemplate,paramEmailText,paramResponseDescript,paramGuidMessageToMobile,paramGuidMessageFromMobile);
			}
