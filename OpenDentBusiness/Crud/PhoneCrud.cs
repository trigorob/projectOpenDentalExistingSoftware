...
namespace OpenDentBusiness.Crud{
	public class PhoneCrud {
		...
		public static long Insert(Phone phone,bool useExistingPK){
			...
			command+="Extension,EmployeeName,ClockStatus,Description,ColorBar,ColorText,EmployeeNum,CustomerNumber,InOrOut,PatNum,DateTimeStart,CustomerNumberRaw,LastCallTimeStart,RingGroups,IsProximal,DateTProximal) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
