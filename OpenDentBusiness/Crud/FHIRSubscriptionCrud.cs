...
namespace OpenDentBusiness.Crud{
	public class FHIRSubscriptionCrud {
		...
		public static long Insert(FHIRSubscription fHIRSubscription,bool useExistingPK){
			...
			OdSqlParameter paramErrorNote=new OdSqlParameter("paramErrorNote",OdDbType.Text,fHIRSubscription.ErrorNote);
			if(useExistingPK || PrefC.RandomKeys) {
				Db.NonQ(command,paramErrorNote);
			}
			else {
				fHIRSubscription.FHIRSubscriptionNum=Db.NonQ(command,true,paramErrorNote);
			}
