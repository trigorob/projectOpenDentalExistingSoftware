...
namespace OpenDentBusiness.Crud{
	public class EmailAutographCrud {
		...
		public static long Insert(EmailAutograph emailAutograph,bool useExistingPK){
			...
			OdSqlParameter paramDescription=new OdSqlParameter("paramDescription",OdDbType.Text,emailAutograph.Description);
			if(emailAutograph.AutographText==null) {
				emailAutograph.AutographText="";
			}
			OdSqlParameter paramAutographText=new OdSqlParameter("paramAutographText",OdDbType.Text,emailAutograph.AutographText);
			if(useExistingPK || PrefC.RandomKeys) {
				Db.NonQ(command,paramDescription,paramAutographText);
			}
			else {
				emailAutograph.EmailAutographNum=Db.NonQ(command,true,paramDescription,paramAutographText);
			}
