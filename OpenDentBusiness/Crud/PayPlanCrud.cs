...
namespace OpenDentBusiness.Crud{
	public class PayPlanCrud {
		...
		public static long Insert(PayPlan payPlan,bool useExistingPK){
			...
			command+="PatNum,Guarantor,PayPlanDate,APR,Note,PlanNum,CompletedAmt,InsSubNum,PaySchedule,NumberOfPayments,PayAmt,DownPayment,IsClosed,Signature,SigIsTopaz) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
		...
		public static void Update(PayPlan payPlan){
			string command="UPDATE payplan SET "
				...
				+"Signature       = '"+POut.String(payPlan.Signature)+"', "
		...
		public static bool Update(PayPlan payPlan,PayPlan oldPayPlan){
			...
			if(payPlan.Signature != oldPayPlan.Signature) {
				if(command!=""){ command+=",";}
				command+="Signature = '"+POut.String(payPlan.Signature)+"'";
			}
