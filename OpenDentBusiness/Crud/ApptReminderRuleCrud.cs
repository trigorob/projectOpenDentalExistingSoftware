...
namespace OpenDentBusiness.Crud{
	public class ApptReminderRuleCrud {
		...
		public static long Insert(ApptReminderRule apptReminderRule,bool useExistingPK){
			...
			command+="TypeCur,TSPrior,SendOrder,IsSendAll,TemplateSMS,TemplateEmailSubject,TemplateEmail,ClinicNum,TemplateSMSAggShared,TemplateSMSAggPerAppt,TemplateEmailSubjAggShared,TemplateEmailAggShared,TemplateEmailAggPerAppt) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
			...
			OdSqlParameter paramTemplateSMS=new OdSqlParameter("paramTemplateSMS",OdDbType.Text,apptReminderRule.TemplateSMS);
			if(apptReminderRule.TemplateEmailSubject==null) {
				apptReminderRule.TemplateEmailSubject="";
			}
			OdSqlParameter paramTemplateEmailSubject=new OdSqlParameter("paramTemplateEmailSubject",OdDbType.Text,apptReminderRule.TemplateEmailSubject);
			if(apptReminderRule.TemplateEmail==null) {
				apptReminderRule.TemplateEmail="";
			}
			OdSqlParameter paramTemplateEmail=new OdSqlParameter("paramTemplateEmail",OdDbType.Text,apptReminderRule.TemplateEmail);
			if(apptReminderRule.TemplateSMSAggShared==null) {
				apptReminderRule.TemplateSMSAggShared="";
			}
			OdSqlParameter paramTemplateSMSAggShared=new OdSqlParameter("paramTemplateSMSAggShared",OdDbType.Text,apptReminderRule.TemplateSMSAggShared);
			if(apptReminderRule.TemplateSMSAggPerAppt==null) {
				apptReminderRule.TemplateSMSAggPerAppt="";
			}
			OdSqlParameter paramTemplateSMSAggPerAppt=new OdSqlParameter("paramTemplateSMSAggPerAppt",OdDbType.Text,apptReminderRule.TemplateSMSAggPerAppt);
			if(apptReminderRule.TemplateEmailSubjAggShared==null) {
				apptReminderRule.TemplateEmailSubjAggShared="";
			}
			OdSqlParameter paramTemplateEmailSubjAggShared=new OdSqlParameter("paramTemplateEmailSubjAggShared",OdDbType.Text,apptReminderRule.TemplateEmailSubjAggShared);
			if(apptReminderRule.TemplateEmailAggShared==null) {
				apptReminderRule.TemplateEmailAggShared="";
			}
			OdSqlParameter paramTemplateEmailAggShared=new OdSqlParameter("paramTemplateEmailAggShared",OdDbType.Text,apptReminderRule.TemplateEmailAggShared);
			if(apptReminderRule.TemplateEmailAggPerAppt==null) {
				apptReminderRule.TemplateEmailAggPerAppt="";
			}
			OdSqlParameter paramTemplateEmailAggPerAppt=new OdSqlParameter("paramTemplateEmailAggPerAppt",OdDbType.Text,apptReminderRule.TemplateEmailAggPerAppt);
			if(useExistingPK || PrefC.RandomKeys) {
				...
				apptReminderRule.ApptReminderRuleNum=Db.NonQ(command,true,paramTemplateSMS,paramTemplateEmailSubject,paramTemplateEmail,paramTemplateSMSAggShared,paramTemplateSMSAggPerAppt,paramTemplateEmailSubjAggShared,paramTemplateEmailAggShared,paramTemplateEmailAggPerAppt);
			}
